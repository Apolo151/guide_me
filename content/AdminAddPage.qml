...
Item {
    ...
    Image {
        ...
        x: 293
        y: 87
        source: "file:///d:/Programming/Projects/GuideMe/content/images/10- Admin Add Page/AddPanel.png"
        fillMode: Image.PreserveAspectFit
    }
        ...
        Button {
            ...
            Rectangle {
                ...
                Image {
                    id: addIcon
                    anchors.verticalCenter: parent.verticalCenter
                    source: "file:///d:/Programming/Projects/GuideMe/content/images/Admin Sidebar/Add Activated.png"
                    fillMode: Image.PreserveAspectFit
                    anchors.horizontalCenter: parent.horizontalCenter
                }
            }
