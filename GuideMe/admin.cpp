    ...
    while (true) {
        ...
        if (choice < 1 || choice > 6) {
            ...
            if (choice == 3) {
                ...
                system("cls");
                cout << "Road updated successfully.\n\n";
            }
            if (choice == 4) {
                string city1, city2;
                int cost;
...
void Admin::selectRoad(string& city1, string& city2, int& cost, transportations& tr) {
    int t;
...
// find it, update name, and update name in all connections
    ...
    for (auto i : adjList[name]) {  // erase all connections
        auto city = i.first;  auto  connections = i.second;
...
void Admin::addRoad(string& city1, string& city2, int cost, transportations transportation) {
...
void Admin::updateRoad(string& city1, string& city2, int cost, transportations transportation,
