    ...
    for (auto i : Map::adjList) {
        for (auto j : i.second) {
            ...
            cout << "\n"
                 ...
                 << endl;
            for (auto road : j.second.roads) {
                cout << i.first << " - " << j.first << " with " << enumToStr[road.transport]
                     << ", costs " << road.cost << endl;
            }
        }
    }
}
